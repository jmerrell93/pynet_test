...
recipient = 'michael@methridge.com'
...
message = 'This is an awesome and somewhat hokey automated alert informing you that the following device has undergone recent configuration change\n\n- - - - - - - - -\nDEVICE NAME\n%s\n\nUPTIME AT TIME OF LAST CONFIGURATION CHANGE\n%s\n\nThe Source Code for this script can be found at https://github.com/jmerrell93/pynet_work/blob/master/config_monitor.py :D' %(info_1, info_2)
